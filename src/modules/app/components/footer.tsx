      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 lg:px-16 xl:px-24">
        <div className="flex items-center justify-between gap-4 rounded-2xl border border-border/40 bg-background/40 backdrop-blur-sm px-4 py-3 text-xs text-muted-foreground">
          <p className="truncate">
            Licenza <span className="font-medium text-foreground">MIT</span> · ©{" "}
            {year}{" "}
            <span className="font-medium text-foreground">Dario Pratola</span>
          </p>
          <div className="flex items-center gap-3">
            <a
              href="https://www.iubenda.com/privacy-policy/94157635"
            ...
            <a
              href="https://www.iubenda.com/privacy-policy/94157635/cookie-policy"
              className="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe "
              title="Cookie Policy "
            >
              {" "}
